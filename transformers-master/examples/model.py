class MultitaskBert(nn.Module):
    def __init__(self, config, original_model):
        ...
        self.classifier_task1 = nn.Linear(config.hidden_size, self.config.num_labels)

        self.dropout_task2 = nn.Dropout(config.hidden_dropout_prob)
        self.classifier_task2 = nn.Linear(config.hidden_size, self.config.num_labels)

        self.dropout_task3 = nn.Dropout(config.hidden_dropout_prob)
        self.classifier_task3 = nn.Linear(config.hidden_size, self.config.num_labels)
