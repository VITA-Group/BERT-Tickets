...
def main():
    ...
    pruning_model_random(model, args.pretrained)
    ...
    #         print('random intial', random_seed)
    #         set_seed_new(random_seed)
    #         random_model = model_class(config=config)
    #         weight_rewind = random_model.state_dict()

    #     elif args.dir == 'pre':
    #         print('pretrain weight')
    #         weight_rewind = model.state_dict()

    #     else:
    #         print('theta0_weight')
    #         weight_rewind = torch.load(args.dir, map_location=args.device)


    # pretrained_model = torch.load(os.path.join(args.pretrained))
    # model.bert = pretrained_model.bert 
    # zero_rate = see_weight_rate(model)
    # zero_rate_pre = see_weight_rate(pretrained_model)
    # print('model 0:',zero_rate)
    # print('pre_model 0:',zero_rate_pre)

    # if args.dir:

    #     weight_orig = rewind(weight_rewind)
    #     for key in weight_orig.keys():
    #         print(key)

    #     print('start rewinding')
    #     model_dict = model.state_dict()
    #     model_dict.update(weight_orig)
