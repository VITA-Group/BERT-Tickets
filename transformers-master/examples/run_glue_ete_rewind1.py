...
from prun_utils import pruning_model,see_weight_rate,rewind
...
def main():
    ...
    parser.add_argument(
        "--sparsity", default=0.1, type=float, help="pruning rate",
    )
    parser.add_argument(
        "--max_steps",
        default=-1,
    ...
    parser.add_argument("--logging_steps", type=int, default=6000, help="Log every X updates steps.")
    parser.add_argument("--save_steps", type=int, default=6000, help="Save checkpoint every X updates steps.")
    parser.add_argument(
    ...
    model = torch.load('tmpetere_wp/CoLA_0/checkpoint-1600/model.pt', map_location='cpu')
    print('loading model from tmpetere_wp/CoLA_0/checkpoint-1600/model.pt')
