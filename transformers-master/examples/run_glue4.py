...
def main():
    ...
    origin_model_dict = torch.load('tmp/pre_rewind_fromrand/theta0_weight.pt')
    # origin_model_dict = model.state_dict()
    # noise_weight = adding_noise(origin_model_dict, 0.01*0.0387)
    # print('rewind random weight')
    ...
    print('rewind')
    random_weight_orig = rewind(origin_model_dict)
    model_dict = model.state_dict()
    model_dict.update(random_weight_orig)
