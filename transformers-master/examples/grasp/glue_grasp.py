...
def GraSP(model, ratio, inputs_list, device, original_mask=None):
    eps = 1e-10
    offset = 2e20
    keep_ratio = 1-ratio
    # old_net = net
...
def main():
    ...
    parser.add_argument("--tt", default=0.5, type=float, help="The initial learning rate for Adam.")
