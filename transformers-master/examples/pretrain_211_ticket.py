...
def rewind(pre_weight):
    recover_dict = {}
    for ii in range(12):
        recover_dict['module.bert.encoder.layer.'+str(ii)+'.attention.self.query.weight_orig'] = pre_weight['module.bert.encoder.layer.'+str(ii)+'.attention.self.query.weight']
        recover_dict['module.bert.encoder.layer.'+str(ii)+'.attention.self.key.weight_orig'] = pre_weight['module.bert.encoder.layer.'+str(ii)+'.attention.self.key.weight']
        recover_dict['module.bert.encoder.layer.'+str(ii)+'.attention.self.value.weight_orig'] = pre_weight['module.bert.encoder.layer.'+str(ii)+'.attention.self.value.weight']
        recover_dict['module.bert.encoder.layer.'+str(ii)+'.attention.output.dense.weight_orig'] = pre_weight['module.bert.encoder.layer.'+str(ii)+'.attention.output.dense.weight']
        recover_dict['module.bert.encoder.layer.'+str(ii)+'.intermediate.dense.weight_orig'] = pre_weight['module.bert.encoder.layer.'+str(ii)+'.intermediate.dense.weight']
        recover_dict['module.bert.encoder.layer.'+str(ii)+'.output.dense.weight_orig'] = pre_weight['module.bert.encoder.layer.'+str(ii)+'.output.dense.weight']
    recover_dict['module.bert.pooler.dense.weight_orig'] = pre_weight['module.bert.pooler.dense.weight']
