...
def main():
    ...
    origin_model_dict.update(noise_weight)
    model.load_state_dict(origin_model_dict)

    rewind_dict = rewind(noise_weight)
    ...
    if args.do_train:
        ...
        global_step, tr_loss = train(args, train_dataset, model, tokenizer, rewind_dict)
